  ...
  const ratioGroups = [
    ...
    },
    {
      ...
      ratios: [
        ...
        { key: 'ROIC', label: 'ROIC', format: (v: number) => `${(v * 100).toFixed(1)}%` },
    ...
    },
    {
      ...
      ratios: [
        ...
        { key: 'QuickRatio', label: 'Ratio Rapide', format: (v: number) => v.toFixed(2) },
      ],
    },
    {
      title: 'Dividendes',
    ...
    },
    {
      ...
      ratios: [
        ...
        { key: 'BookValueGrowth', label: 'Croissance Valeur Comptable', format: (v: number) => `${(v * 100).toFixed(1)}%` },
      ],
    },
    {
      title: 'Autres',
